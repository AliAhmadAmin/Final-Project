...
<body style="background-image: url('bg.jpg'); height: 50px; background-size: cover; ">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a class="navbar-brand" href="#">Amin Human Welfare Center</a>
    <div class="">
    <ul style="padding-left: 600px;" class="navbar-nav ml-auto ">
       <li  class="nav-item active Center">
        <li style="" class="nav-item active">
        <button style="padding: 6px; color: white; background-color: grey;" type="button" class="btn btn mx-2" onclick="getDBtable()">Users List</button>
      </li>
      <li  class="nav-item active Center">
        <li style="" class="nav-item active">
        <button style="padding: 6px; color: white; background-color: red;" type="button" class="btn btn mx-2" onclick="addForm()">+ Add</button>
      </li>
        <input type="text" id="searchBtn" placeholder="Search.." name="search">
      <button style="padding: 6px; color: white; background-color: red;" type="button" onclick="getData()"><i class="fa fa-search"></i>Search</button>
      </li><br>
    ...
    <div class="container"><br>
      <div class="row card" style="background-color: rgba(245, 245, 245, 1); opacity: .8">
        <div class="col-md-12">
